/* GOLDEN FIXTURE — snapshot of dodgeball-play-animator/plays.js for parity tests.
 * Hand-authored play objects. DBN examples must compile byte-identical to these.
 * Snapshot only; the live source is the animator repo. */
